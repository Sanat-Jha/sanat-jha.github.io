...
function loadaboutme() {
  const aboutme = `I’m a sophomore at IIT Roorkee, currently pursuing BTech in Production and Industrial Engineering, but most of my time is spent building software, experimenting with ideas, and turning concepts into working products.

I enjoy creating end-to-end systems,  from intuitive mobile apps in Flutter to scalable backend architectures using Django. I’ve worked across multiple tech domains, including web development, backend systems, and even hardware-focused projects like drone engineering, which has helped me develop a strong problem-solving mindset.
`;
